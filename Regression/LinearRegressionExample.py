...
# Use pandas read_csv function to import the dataset
autosmpg = pd.read_csv("C:/Users/justi/OneDrive/Documents/TDAI sci-kit learn final/Regression/auto-mpgdata.csv", 
                       header = 1, names = ["mpg", 
                                            "cylinders", 
                                            "displacement", 
                                            "horsepower", 
...
pd.plotting.scatter_matrix(autosmpg, alpha=0.2, figsize=(9, 9), diagonal='kde')
...
feature_cols = ["recip_weight", "log_acceleration", "model_year"]
...
# Sci-kit learn ML algorithms and their results are stored in objects
# Linear Regression results are stored in a linear regression object
